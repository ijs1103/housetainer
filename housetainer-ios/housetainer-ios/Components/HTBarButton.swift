...
final class HTBarButton: UIButton{
    var isLoading: Bool{
    ...
    private var loadingView = {
        ...
        view.color = Color.reddishPurple500
        return view
    }()
}
...
private extension HTBarButton{
    func setupUI(){
        addSubview(loadingView)
        
        titleLabel?.font = Typo.Body1Medium()
        
        setTitleColor(Color.gray500, for: .disabled)
        setTitleColor(Color.reddishPurple500, for: .normal)
